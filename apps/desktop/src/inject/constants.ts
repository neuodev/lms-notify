...
export const MESSAGE_TEMPLATES = [
  {
    label: "تسجيل غياب",
    text: `
    السلام عليكم أ/ {{parentName}}
تم تسجيل غياب الطالب/ {{studentName}} عن اليوم الدراسي بتاريخ ....

نرجو إبلاغنا بسبب الغياب للاطمئنان والمتابعة الأكاديمية.

في حال وجود عذر رسمي، يرجى إبلاغ إدارة المدرسة مباشرة عبر القنوات الرسمية المعتمدة.
مع خالص التقدير 🤝
    `,
  },
  {
    label: "إعلان درجات",
    text: `اعلان درجات 
نحيطكم علمًا بأنه تم اعتماد نتائج الطالب {{studentName}}
 يرجى مراجعة منصة الـLMS للاطلاع على التفاصيل.
مع خالص التقدير.`,
  },
  {
    label: "تهنئة نجاح",
...
بكل فخر، نهنئكم بنجاح {{studentName}} 🎓

هذا الإنجاز هو ثمرة اجتهاده ودعمكم المستمر،
ونسأل الله له مزيدًا من التفوق والنجاحات القادمة. 🌟
    `,
  },
  {
    label: "إشعار رسوب",
    text: `
    نود إعلامكم بأن ابنكم {{studentName}} لم ينجح في امتحانات العام {{level}}. نقدر قلقكم، وننصح بمراجعة النتائج مع المعلمين لوضع خطة لدعمه في العام القادم. لأي استفسار، يمكنكم التواصل معنا مباشرة عبر هذا الرقم.
    `,
  },
  {
    label: "إعلان عاجل",
